...
extern int (*snd_ctl_add_enumerated_elem_set_dylibloader_wrapper_asound)(snd_ctl_t *, snd_ctl_elem_info_t *, unsigned int, unsigned int, unsigned int, const char * const []);
...
extern int (*snd_ctl_elem_add_enumerated_dylibloader_wrapper_asound)(snd_ctl_t *, const snd_ctl_elem_id_t *, unsigned int, unsigned int, const char * const []);
...
extern int (*snd_mixer_elem_new_dylibloader_wrapper_asound)(snd_mixer_elem_t **, snd_mixer_elem_type_t, int, void *, void (*)(snd_mixer_elem_t *elem));
...
extern int (*snd_mixer_class_set_private_free_dylibloader_wrapper_asound)(snd_mixer_class_t *, void (*)(snd_mixer_class_t *));
