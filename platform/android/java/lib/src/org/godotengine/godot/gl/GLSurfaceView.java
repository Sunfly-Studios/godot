...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
	...
	private abstract class BaseConfigChooser
		...
		private int[] filterConfigSpec(int[] configSpec) {
			if (mEGLContextClientVersion != 1 && mEGLContextClientVersion != 2 && mEGLContextClientVersion != 3) {
				return configSpec;
			}
			...
			if (mEGLContextClientVersion == 1) {
				newConfigSpec[len] = 0x0001; /* EGL_OPENGL_ES_BIT */
			} else if (mEGLContextClientVersion == 2) {
