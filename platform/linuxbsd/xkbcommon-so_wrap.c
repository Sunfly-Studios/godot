...
// generated by generate-wrapper.py 0.7 on 2026-03-13 16:30:12
...
// xkb_keysym_get_name
  {
    ...
    __builtin_memcpy(&xkb_keysym_get_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keysym_from_name
  {
    ...
    __builtin_memcpy(&xkb_keysym_from_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keysym_to_utf8
  {
    ...
    __builtin_memcpy(&xkb_keysym_to_utf8_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keysym_to_utf32
  {
    ...
    __builtin_memcpy(&xkb_keysym_to_utf32_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_utf32_to_keysym
  {
    ...
    __builtin_memcpy(&xkb_utf32_to_keysym_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keysym_to_upper
  {
    ...
    __builtin_memcpy(&xkb_keysym_to_upper_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keysym_to_lower
  {
    ...
    __builtin_memcpy(&xkb_keysym_to_lower_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_new
  {
    ...
    __builtin_memcpy(&xkb_context_new_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_ref
  {
    ...
    __builtin_memcpy(&xkb_context_ref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_unref
  {
    ...
    __builtin_memcpy(&xkb_context_unref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_set_user_data
  {
    ...
    __builtin_memcpy(&xkb_context_set_user_data_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_get_user_data
  {
    ...
    __builtin_memcpy(&xkb_context_get_user_data_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_include_path_append
  {
    ...
    __builtin_memcpy(&xkb_context_include_path_append_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_include_path_append_default
  {
    ...
    __builtin_memcpy(&xkb_context_include_path_append_default_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_include_path_reset_defaults
  {
    ...
    __builtin_memcpy(&xkb_context_include_path_reset_defaults_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_include_path_clear
  {
    ...
    __builtin_memcpy(&xkb_context_include_path_clear_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_num_include_paths
  {
    ...
    __builtin_memcpy(&xkb_context_num_include_paths_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_include_path_get
  {
    ...
    __builtin_memcpy(&xkb_context_include_path_get_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_set_log_level
  {
    ...
    __builtin_memcpy(&xkb_context_set_log_level_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_get_log_level
  {
    ...
    __builtin_memcpy(&xkb_context_get_log_level_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_set_log_verbosity
  {
    ...
    __builtin_memcpy(&xkb_context_set_log_verbosity_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_get_log_verbosity
  {
    ...
    __builtin_memcpy(&xkb_context_get_log_verbosity_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_context_set_log_fn
  {
    ...
    __builtin_memcpy(&xkb_context_set_log_fn_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_new_from_names
  {
    ...
    __builtin_memcpy(&xkb_keymap_new_from_names_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_new_from_file
  {
    ...
    __builtin_memcpy(&xkb_keymap_new_from_file_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_new_from_string
  {
    ...
    __builtin_memcpy(&xkb_keymap_new_from_string_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_new_from_buffer
  {
    ...
    __builtin_memcpy(&xkb_keymap_new_from_buffer_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_ref
  {
    ...
    __builtin_memcpy(&xkb_keymap_ref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_unref
  {
    ...
    __builtin_memcpy(&xkb_keymap_unref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_get_as_string
  {
    ...
    __builtin_memcpy(&xkb_keymap_get_as_string_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_min_keycode
  {
    ...
    __builtin_memcpy(&xkb_keymap_min_keycode_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_max_keycode
  {
    ...
    __builtin_memcpy(&xkb_keymap_max_keycode_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_key_for_each
  {
    ...
    __builtin_memcpy(&xkb_keymap_key_for_each_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_key_get_name
  {
    ...
    __builtin_memcpy(&xkb_keymap_key_get_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_key_by_name
  {
    ...
    __builtin_memcpy(&xkb_keymap_key_by_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_num_mods
  {
    ...
    __builtin_memcpy(&xkb_keymap_num_mods_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_mod_get_name
  {
    ...
    __builtin_memcpy(&xkb_keymap_mod_get_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_mod_get_index
  {
    ...
    __builtin_memcpy(&xkb_keymap_mod_get_index_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_num_layouts
  {
    ...
    __builtin_memcpy(&xkb_keymap_num_layouts_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_layout_get_name
  {
    ...
    __builtin_memcpy(&xkb_keymap_layout_get_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_layout_get_index
  {
    ...
    __builtin_memcpy(&xkb_keymap_layout_get_index_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_num_leds
  {
    ...
    __builtin_memcpy(&xkb_keymap_num_leds_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_led_get_name
  {
    ...
    __builtin_memcpy(&xkb_keymap_led_get_name_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_led_get_index
  {
    ...
    __builtin_memcpy(&xkb_keymap_led_get_index_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_num_layouts_for_key
  {
    ...
    __builtin_memcpy(&xkb_keymap_num_layouts_for_key_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_num_levels_for_key
  {
    ...
    __builtin_memcpy(&xkb_keymap_num_levels_for_key_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_key_get_mods_for_level
  {
    ...
    __builtin_memcpy(&xkb_keymap_key_get_mods_for_level_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_key_get_syms_by_level
  {
    ...
    __builtin_memcpy(&xkb_keymap_key_get_syms_by_level_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_keymap_key_repeats
  {
    ...
    __builtin_memcpy(&xkb_keymap_key_repeats_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_new
  {
    ...
    __builtin_memcpy(&xkb_state_new_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_ref
  {
    ...
    __builtin_memcpy(&xkb_state_ref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_unref
  {
    ...
    __builtin_memcpy(&xkb_state_unref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_get_keymap
  {
    ...
    __builtin_memcpy(&xkb_state_get_keymap_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_update_key
  {
    ...
    __builtin_memcpy(&xkb_state_update_key_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_update_mask
  {
    ...
    __builtin_memcpy(&xkb_state_update_mask_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_syms
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_syms_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_utf8
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_utf8_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_utf32
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_utf32_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_one_sym
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_one_sym_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_layout
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_layout_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_level
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_level_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_serialize_mods
  {
    ...
    __builtin_memcpy(&xkb_state_serialize_mods_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_serialize_layout
  {
    ...
    __builtin_memcpy(&xkb_state_serialize_layout_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_name_is_active
  {
    ...
    __builtin_memcpy(&xkb_state_mod_name_is_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_names_are_active
  {
    ...
    __builtin_memcpy(&xkb_state_mod_names_are_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_index_is_active
  {
    ...
    __builtin_memcpy(&xkb_state_mod_index_is_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_indices_are_active
  {
    ...
    __builtin_memcpy(&xkb_state_mod_indices_are_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_consumed_mods2
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_consumed_mods2_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_key_get_consumed_mods
  {
    ...
    __builtin_memcpy(&xkb_state_key_get_consumed_mods_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_index_is_consumed2
  {
    ...
    __builtin_memcpy(&xkb_state_mod_index_is_consumed2_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_index_is_consumed
  {
    ...
    __builtin_memcpy(&xkb_state_mod_index_is_consumed_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_mod_mask_remove_consumed
  {
    ...
    __builtin_memcpy(&xkb_state_mod_mask_remove_consumed_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_layout_name_is_active
  {
    ...
    __builtin_memcpy(&xkb_state_layout_name_is_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_layout_index_is_active
  {
    ...
    __builtin_memcpy(&xkb_state_layout_index_is_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_led_name_is_active
  {
    ...
    __builtin_memcpy(&xkb_state_led_name_is_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_state_led_index_is_active
  {
    ...
    __builtin_memcpy(&xkb_state_led_index_is_active_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_table_new_from_locale
  {
    ...
    __builtin_memcpy(&xkb_compose_table_new_from_locale_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_table_new_from_file
  {
    ...
    __builtin_memcpy(&xkb_compose_table_new_from_file_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_table_new_from_buffer
  {
    ...
    __builtin_memcpy(&xkb_compose_table_new_from_buffer_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_table_ref
  {
    ...
    __builtin_memcpy(&xkb_compose_table_ref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_table_unref
  {
    ...
    __builtin_memcpy(&xkb_compose_table_unref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_new
  {
    ...
    __builtin_memcpy(&xkb_compose_state_new_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_ref
  {
    ...
    __builtin_memcpy(&xkb_compose_state_ref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_unref
  {
    ...
    __builtin_memcpy(&xkb_compose_state_unref_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_get_compose_table
  {
    ...
    __builtin_memcpy(&xkb_compose_state_get_compose_table_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_feed
  {
    ...
    __builtin_memcpy(&xkb_compose_state_feed_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_reset
  {
    ...
    __builtin_memcpy(&xkb_compose_state_reset_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_get_status
  {
    ...
    __builtin_memcpy(&xkb_compose_state_get_status_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_get_utf8
  {
    ...
    __builtin_memcpy(&xkb_compose_state_get_utf8_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
...
// xkb_compose_state_get_one_sym
  {
    ...
    __builtin_memcpy(&xkb_compose_state_get_one_sym_dylibloader_wrapper_xkbcommon, &tmp_dlsym, sizeof(void *));
  }
  if (verbose) {
    error = dlerror();
    if (error != NULL) {
