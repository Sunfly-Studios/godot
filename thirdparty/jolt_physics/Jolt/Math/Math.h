...
inline uint CountTrailingZeros(uint32 inValue)
{
		...
		return __builtin_ctz(inValue);
	#endif
#elif defined(JPH_CPU_E2K) || defined(JPH_CPU_RISCV) || defined(JPH_CPU_PPC) || defined(JPH_CPU_LOONGARCH) || defined(JPH_CPU_SPARC) || defined(JPH_CPU_MIPS) || defined(JPH_CPU_ALPHA) || defined(JPH_CPU_HPPA) || defined(JPH_CPU_ARC)
