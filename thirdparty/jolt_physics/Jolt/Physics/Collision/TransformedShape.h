...
#if defined(REAL_T_IS_DOUBLE) && (defined(JPH_CPU_PPC) || defined(JPH_CPU_SPARC) || defined(JPH_CPU_MIPS) || defined(JPH_CPU_LOONGARCH) || defined(JPH_CPU_ALPHA) || defined(JPH_CPU_HPPA) || defined(JPH_CPU_ARC))
