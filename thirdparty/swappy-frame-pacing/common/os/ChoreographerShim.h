...
// TODO: Check if Android 4.4 will be fine with these.
 ...
 * when it's called.
 */
typedef void (*AChoreographer_postVsyncCallback_fn)(AChoreographer* choreographer,
 ...
 */
typedef size_t (*AChoreographerFrameCallbackData_getPreferredFrameTimelineIndex_fn)(
 ...
 * animation clocks.
 */
typedef int64_t (*AChoreographerFrameCallbackData_getFrameTimelineExpectedPresentationTimeNanos_fn)(
 ...
 */
typedef int64_t (*AChoreographerFrameCallbackData_getFrameTimelineDeadlineNanos_fn)(
        const AChoreographerFrameCallbackData* data, size_t index);
