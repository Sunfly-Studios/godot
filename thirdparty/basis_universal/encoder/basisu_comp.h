...
namespace basisu
{
	...
	private:
		...
		bool generate_mipmaps(const imagef& img, basisu::vector<imagef>& mips_levels, bool has_alpha);
		bool generate_mipmaps(const image &img, basisu::vector<image> &mips_levels, bool has_alpha);
